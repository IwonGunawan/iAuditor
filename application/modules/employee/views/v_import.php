          ...
          <div class="card">
            <div class="card-body">
              ...
              <ol style="margin-left: 10px; font-size: 12px;">
                <li>Silakan download template <a href="<?=base_url('assets/employee.xlsx');?>" target="_blank">employee.xlsx</a></li>
                <li>ketikan data karyawan yang ingin di import pada file employee.xlsx > setelah selesai lalu save</li>
                <li>Pada <b>form import data</b> klik "Choose file" lalu pilih employee.xlsx yang telah di isi</li>
            ...
            <div class="card">
              <div class="card-body">
                  <form id="import_form" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="file" id="file_emp" name="file_emp" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
                
                    <button type="submit" id="import" class="btn btn-warning btn-lg btn-block"><i class="fa fa-upload"></i>&nbsp; Import</button>
                  </form>

                  <form action="<?=base_url('employee/importSave');?>" id="save_form" method="POST">
                    <input type="hidden" id="text_emp" name="text_emp" >
...
<script type="text/javascript">
  ...
  $('#import_form').on('submit', function(event)
  {
    ...
    $.ajax({
      ...
      url     : "<?php echo base_url('employee/importSubmit');?>",
      method  : "POST",
