                  ...
                  <div class="col-md-6">
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <p class="form-control-static"><?=$data['employeeNik'];?></p>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Fullname</label></div>
                        <div class="col-12 col-md-9">
                            <p class="form-control-static"><?=$data['employeeName'];?></p>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Site</label></div>
                        <div class="col-12 col-md-9">
                            <p class="form-control-static"><?=$data['site'];?></p>
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Job Position</label></div>
                        <div class="col-12 col-md-9">
                            <p class="form-control-static"><?=$data['jobPosition'];?></p>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Level</label></div>
                        <div class="col-12 col-md-9">
                            <p class="form-control-static"><?=$data['level'];?></p>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Sub Level</label></div>
                        <div class="col-12 col-md-9">
                            <p class="form-control-static"><?=$data['subLevel'];?></p>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label">Email</label></div>
                        <div class="col-12 col-md-9">
                            <p class="form-control-static"><?=$data['officeMail'];?></p>
                        </div>
                    </div>
                  </div>
