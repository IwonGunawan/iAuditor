                ...
                <div class="card-body card-block">
                  <div class="col-md-10">
                    <div class="row form-group">
                        <div class="col col-md-4"><label class=" form-control-label">Training Name</label></div>
                        <div class="col-12 col-md-8">
                            <p class="form-control-static"><?=$data['trainingName'];?></p>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-4"><label class=" form-control-label">Content</label></div>
                        <div class="col-12 col-md-8">
                            <p class="form-control-static"><?=$data['trainingContent'];?></p>
                        </div>
                    </div>
                  </div>
